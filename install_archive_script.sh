#!/bin/sh
# Skrypt install_archive_script.sh (v6.1) - Zgodny z AIO Panel v6.1
...
# Start logging
echo "--- START install_archive_script.sh (v6.1) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v6.1) ---" >> "$LOG_FILE"
