#!/bin/sh
# Skrypt install_archive_script.sh (v9.2) - Zgodny z AIO Panel v5.0
...
# Start logging
echo "--- START install_archive_script.sh (v9.2) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v9.2) ---" >> "$LOG_FILE"
