#!/bin/sh
# Skrypt install_archive_script.sh (v9.7) - Zgodny z AIO Panel
...
# Start logging
echo "--- START install_archive_script.sh (v9.7) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v9.7) ---" >> "$LOG_FILE"
