#!/bin/sh
# Skrypt install_archive_script.sh (v9.1.1) - Zgodny z AIO Panel v5.0
...
# Start logging
echo "--- START install_archive_script.sh (v9.1.1) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v9.1.1) ---" >> "$LOG_FILE"
