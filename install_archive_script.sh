#!/bin/sh
# Skrypt install_archive_script.sh (v6.0) - Zgodny z AIO Panel v6.0
...
# Start logging
echo "--- START install_archive_script.sh (v6.0) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v6.0) ---" >> "$LOG_FILE"
