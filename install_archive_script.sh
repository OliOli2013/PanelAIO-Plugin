#!/bin/sh
# Skrypt install_archive_script.sh (v11.0) - Zgodny z AIO Panel
...
# Start logging
echo "--- START install_archive_script.sh (v11.0) ---" > "$LOG_FILE"
...
# --- Komunikat końcowy ---
echo "--- KONIEC install_archive_script.sh (v11.0) ---" >> "$LOG_FILE"
